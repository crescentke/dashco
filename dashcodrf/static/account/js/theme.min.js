...
var Dropdowns = function () {
    var t = $(".dropup, .dropright, .dropdown, .dropleft"), e = $(".dropdown-menu"),
    ...
    var a = $('[data-toggle="chart"]'), t = {base: "Cerebri Sans"}, e = {
        gray: {100: "#95AAC9", 300: "#E3EBF6", 600: "#95AAC9", 700: "#6E84A3", 900: "#283E59"},
        ...
        defaults: {
            global: {
                ...
                elements: {
                    point: {radius: 0, backgroundColor: e.primary[700]},
                    line: {
                        tension: .4,
                        borderWidth: 3,
                    ...
                    rectangle: {backgroundColor: e.primary[700]},
                    arc: {borderWidth: 4, backgroundColor: e.primary[700]}
                },
                tooltips: {
                    enabled: !1, mode: "index", intersect: !1, custom: function (o) {
                        ...
                        if (a.length || (a = $('<div id="chart-tooltip" class="popover bs-popover-top" role="tooltip"></div>'), $("body").append(a)), 0 !== o.opacity) {
                            if (o.body) {
                                var t = o.title || [], n = o.body.map(function (a) {
                                    return a.lines
                                }), s = "";
                            ...
                            var e = $(this._chart.canvas), r = (e.outerWidth(), e.outerHeight(), e.offset().top),
                                l = e.offset().left, i = a.outerWidth(), d = a.outerHeight(), c = r + o.caretY - d - 16,
                                p = l + o.caretX - i / 2;
                            a.css({top: c + "px", left: p + "px", display: "block"})
                        } else a.css("display", "none")
                    }, callbacks: {
                        label: function (a, t) {
                            var e = t.datasets[a.datasetIndex].label || "", r = a.yLabel, o = "";
    ...
    function o(a, t) {
        for (var e in t) "object" != typeof t[e] ? a[e] = t[e] : o(a[e], t[e])
    }

    function n(a) {
        var t = a.data("add"), e = $(a.data("target")).data("chart");
        a.is(":checked") ? function a(t, e) {
            for (var r in e) Array.isArray(e[r]) ? e[r].forEach(function (a) {
                t[r].push(a)
            }) : a(t[r], e[r])
        }(e, t) : function a(t, e) {
            for (var r in e) Array.isArray(e[r]) ? e[r].forEach(function (a) {
    ...
    function s(a) {
        var t = a.data("update"), e = $(a.data("target")).data("chart");
        o(e, t), function (a, t) {
            if (void 0 !== a.data("prefix") || void 0 !== a.data("prefix")) {
                var n = a.data("prefix") ? a.data("prefix") : "", s = a.data("suffix") ? a.data("suffix") : "";
                t.options.scales.yAxes[0].ticks.callback = function (a) {
                    if (!(a % 10)) return n + a + s
    ...
    }), {fonts: t, colors: e, options: r}
}(), Header = function () {
    var a, t, e = $("#headerChart");
    ...
    var a, t, e = $("#performanceChartAlias");
    e.length && (a = e, t = new Chart(a, {
        type: "line",
        data: {
            labels: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"],
    ...
    var t = $(".navbar-nav, .navbar-nav .nav"), e = $(".navbar-nav .collapse");
    e.on({
    ...
    var a = $('[data-toggle="lists"]'), t = $("[data-sort]");
