...
var select2Demo = {
    ...
    getStates: function getStates() {
        return $('#branch_staff').html();
    },
    getStaff: function getStaff() {
        return $('#plan_staff').html();
    },
    singleSelect: function singleSelect() {
        $('#id_branch_user').append(this.getStates());
        $('#id_branch_user').select2({
            placeholder: 'Select a staff member',
            allowClear: true
        });
    },
    planUser: function singleSelect() {
        $('#id_plan_user').append(this.getStaff());
        $('#id_plan_user').select2({
            placeholder: 'Select a staff member',
            allowClear: true
        });
    },
    ...
    arrayData: function arrayData() {
        var data = [{id: 0, text: 'Visa'}, {id: 1, text: 'Discover Card'}, {id: 2, text: 'American Express'}, {
            id: 3,
            text: 'MasterCard'
        }, {id: 4, text: 'American Express'}];
